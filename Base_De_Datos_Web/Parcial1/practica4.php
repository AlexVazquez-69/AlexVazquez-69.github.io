<?php
    ...
    echo "<h5>Repuesta seleccionada ".$pregunta3." ---- Correcta = Dos diamantes, cuatro de obsidiana y 1 libro</h5>";

    if($pregunta3 == "Dos diamantes, cuatro de obsidiana y 1 libro"){
        $aciertos++;
        echo "<img src='correcta.jpeg' width='50px'><hr>";
    } else {
        echo "<img src='incorrecta.jpeg' width='50px'><hr>";
    ...
    echo "<h5>Repuesta seleccionada ".implode(",", $pregunta8)." ---- Correcta = Markus Persson, Notch </h5><br>";
    $p8 = 0;
